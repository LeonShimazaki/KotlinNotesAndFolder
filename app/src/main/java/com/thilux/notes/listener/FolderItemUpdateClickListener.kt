...
import com.thilux.notes.activity.FolderActivity
import com.thilux.notes.activity.FolderListActivity
 ...
 */
class FolderItemUpdateClickListener(val note: Note, val context: Context) : View.OnClickListener {

    override fun onClick(view: View?) {

        val intent = Intent(context, FolderListActivity::class.java)
